            ...
            <div class="col-12 pb-5 mt-4">
                ...
                <div class="tabs-listing">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item"><a class="nav-link py-4 px-sm-4" href="#specs" data-bs-toggle="tab" role="tab" aria-selected="true">Mục lục sách</a></li>
                    </ul>
...
<?php echo $__env->make($templatePath .'.layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\expro\Laravel\book-ecommerce\resources\views/theme/product/product-single.blade.php ENDPATH**/ ?>