<div class="product-single__meta mt-lg-0 mt-3">
    ...
    <div class="prInfoRow mb-3 d-flex flex-wrap">
        <?php if($product->sku): ?>
        <div class="product-sku me-2">Mã sách: <span class="variant-sku"><?php echo e($product->sku); ?></span></div>
        <?php endif; ?>
        <?php if($brand != ''): ?>
            ...
            <div class="product-btn-group d-flex w-100">
                <div class="product-form__item--submit">
                    <button type="button" name="add" class="btn product-form__cart-add btn-radius btn-primary w-100">
                        ...
                        <span>Thêm vào giỏ -- CanNN đã tới đây</span>
                    </button>
                </div>
...
</div><?php /**PATH C:\wamp64\www\expro\Laravel\book-ecommerce\resources\views/theme/product/product-summary.blade.php ENDPATH**/ ?>